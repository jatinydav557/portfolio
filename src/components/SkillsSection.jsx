...
const skills = [
  ...
  { name: "Tableau", level: 70, category: "Data Analysis" },
  { name: "Power BI", level: 85, category: "Data Analysis" },
  ...
  { name: "XGBoost", level: 85, category: "Machine Learning & AI" },
  { name: "PyTorch / TensorFlow", level: 80, category: "Machine Learning & AI" },
  ...
  { name: "Model Tuning (GridSearchCV / RandomSearch)", level: 80, category: "Machine Learning & AI" },
  ...
  { name: "AstraDB", level: 75, category: "Databases" },

  { name: "GCP (Cloud Run / GKE / Buckets)", level: 85, category: "Cloud" },
  { name: "AWS (EC2 / S3 / Lambda / Bedrock)", level: 80, category: "Cloud" },
  ...
  { name: "Notion (Docs / Planning)", level: 70, category: "Tools" },
